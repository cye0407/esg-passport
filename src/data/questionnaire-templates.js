...
export const QUESTIONNAIRE_TEMPLATES = {
  ...
  csrd_vsme: {
    ...
    questionCount: 20,
    questions: [
      { id: 'vsme-1', text: 'Describe your business model, including principal products/services, markets served, and number of employees.', category: 'General Disclosures', subcategory: 'Business Model', vsmeCode: 'B1' },
      { id: 'vsme-2', text: 'What is your total energy consumption in MWh, split by electricity, heating fuels, and transport fuels?', category: 'Environment', subcategory: 'Energy', vsmeCode: 'B4' },
      { id: 'vsme-3', text: 'What percentage of your energy is from renewable sources?', category: 'Environment', subcategory: 'Energy', vsmeCode: 'B4' },
      { id: 'vsme-4', text: 'What are your Scope 1 GHG emissions (tCO2e) from direct combustion?', category: 'Environment', subcategory: 'Climate', vsmeCode: 'B4' },
      { id: 'vsme-5', text: 'What are your Scope 2 GHG emissions (tCO2e) from purchased electricity, using both location-based and market-based methods?', category: 'Environment', subcategory: 'Climate', vsmeCode: 'B4' },
      { id: 'vsme-6', text: 'What is your total water consumption in m³?', category: 'Environment', subcategory: 'Water', vsmeCode: 'B6' },
      { id: 'vsme-7', text: 'What is the total weight of waste generated, and what percentage is recycled or diverted from landfill?', category: 'Environment', subcategory: 'Waste', vsmeCode: 'B8' },
      { id: 'vsme-8', text: 'Do you generate hazardous waste? If so, how much (in kg or tonnes)?', category: 'Environment', subcategory: 'Waste', vsmeCode: 'B8' },
      { id: 'vsme-9', text: 'Do you have an environmental policy or environmental management system?', category: 'Environment', subcategory: 'Policy', vsmeCode: 'B2' },
      { id: 'vsme-10', text: 'How many employees (FTE) do you have, split by gender?', category: 'Social', subcategory: 'Workforce', vsmeCode: 'B9' },
      { id: 'vsme-11', text: 'What is your employee turnover rate for the reporting period?', category: 'Social', subcategory: 'Workforce', vsmeCode: 'B9' },
      { id: 'vsme-12', text: 'How many work-related injuries and fatalities occurred?', category: 'Social', subcategory: 'Health & Safety', vsmeCode: 'B10' },
      { id: 'vsme-13', text: 'What is the average number of training hours per employee?', category: 'Social', subcategory: 'Training', vsmeCode: 'B11' },
      { id: 'vsme-14', text: 'Do you have policies on human rights, child labor, and forced labor?', category: 'Social', subcategory: 'Human Rights', vsmeCode: 'B9' },
      { id: 'vsme-15', text: 'Do you have a Code of Conduct covering business ethics, anti-corruption, and anti-bribery?', category: 'Governance', subcategory: 'Ethics', vsmeCode: 'B2' },
      { id: 'vsme-16', text: 'Do you have a whistleblowing or grievance mechanism?', category: 'Governance', subcategory: 'Governance', vsmeCode: 'B2' },
      { id: 'vsme-17', text: 'Do you have a Supplier Code of Conduct and do you assess suppliers on sustainability criteria?', category: 'Governance', subcategory: 'Supply Chain', vsmeCode: 'B2' },
      { id: 'vsme-18', text: 'What sustainability-related certifications does your company hold?', category: 'Governance', subcategory: 'Certifications', vsmeCode: 'B2' },
      { id: 'vsme-19', text: 'Do you have climate targets? Describe your decarbonization roadmap.', category: 'Environment', subcategory: 'Targets', vsmeCode: 'B4' },
      { id: 'vsme-20', text: 'Has any of your sustainability data been externally verified or assured?', category: 'Governance', subcategory: 'Verification', vsmeCode: 'B1' },
    ],
  },
