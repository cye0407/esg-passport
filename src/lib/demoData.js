...
const DEMO_PROFILE = {
  ...
  registeredAddress: 'Industriestraße 24, 40231 Düsseldorf, Germany',
  noSignificantFines: 'none',
  dataProtectionPolicy: 'yes',
  publishesSustainabilityReport: 'no',
  reportingFramework: '',
  externalAssurance: 'no',
  assuranceStandard: '',
  csrdApplicable: 'assessing',
};
...
const DEMO_MONTHLY_RECORDS = [
  {
    period: '2025-01',
    energy: { electricityKwh: 185000, naturalGasKwh: 142000, vehicleFuelLiters: 2800, renewablePercent: 48, energySavingsKwh: 3200 },
    water: { consumptionM3: 620, waterSourceMunicipalPercent: 95 },
    waste: { totalKg: 12400, recycledKg: 9300, hazardousKg: 680, recyclingRate: 75 },
    workforce: { totalEmployees: 276, femaleEmployees: 72, maleEmployees: 204, turnoverRate: 12, womenInLeadershipPercent: 28, collectiveBargainingPercent: 68, grievancesReported: 1, newHires: 3 },
  ...
  {
    period: '2025-02',
    energy: { electricityKwh: 178000, naturalGasKwh: 138000, vehicleFuelLiters: 2650, renewablePercent: 48, energySavingsKwh: 2800 },
    water: { consumptionM3: 595, waterSourceMunicipalPercent: 95 },
    waste: { totalKg: 11800, recycledKg: 8910, hazardousKg: 640, recyclingRate: 75 },
    workforce: { totalEmployees: 276, femaleEmployees: 72, maleEmployees: 204, turnoverRate: 12, womenInLeadershipPercent: 28, collectiveBargainingPercent: 68, grievancesReported: 0, newHires: 2 },
  ...
  {
    period: '2025-03',
    energy: { electricityKwh: 190000, naturalGasKwh: 118000, vehicleFuelLiters: 2900, renewablePercent: 50, energySavingsKwh: 3500 },
    water: { consumptionM3: 645, waterSourceMunicipalPercent: 95 },
    waste: { totalKg: 13100, recycledKg: 10090, hazardousKg: 710, recyclingRate: 77 },
    workforce: { totalEmployees: 278, femaleEmployees: 73, maleEmployees: 205, turnoverRate: 11, womenInLeadershipPercent: 28, collectiveBargainingPercent: 68, grievancesReported: 0, newHires: 4 },
    healthSafety: { recordableIncidents: 1, lostTimeIncidents: 1, fatalities: 0, hoursWorked: 45600 },
    training: { trainingHours: 520 },
    supplyChain: { suppliersAssessedPercent: 38 },
  },
  {
    period: '2025-04',
    energy: { electricityKwh: 192000, naturalGasKwh: 86000, vehicleFuelLiters: 3050, renewablePercent: 50, energySavingsKwh: 3100 },
    water: { consumptionM3: 670, waterSourceMunicipalPercent: 95 },
    waste: { totalKg: 13500, recycledKg: 10530, hazardousKg: 730, recyclingRate: 78 },
    workforce: { totalEmployees: 280, femaleEmployees: 74, maleEmployees: 206, turnoverRate: 11, womenInLeadershipPercent: 29, collectiveBargainingPercent: 68, grievancesReported: 1, newHires: 3 },
    healthSafety: { recordableIncidents: 0, lostTimeIncidents: 0, fatalities: 0, hoursWorked: 46200 },
    training: { trainingHours: 410 },
    supplyChain: { suppliersAssessedPercent: 40 },
  },
  {
    period: '2025-05',
    energy: { electricityKwh: 198000, naturalGasKwh: 52000, vehicleFuelLiters: 3100, renewablePercent: 52, energySavingsKwh: 3800 },
    water: { consumptionM3: 710, waterSourceMunicipalPercent: 95 },
    waste: { totalKg: 14200, recycledKg: 11220, hazardousKg: 760, recyclingRate: 79 },
    workforce: { totalEmployees: 282, femaleEmployees: 75, maleEmployees: 207, turnoverRate: 10, womenInLeadershipPercent: 29, collectiveBargainingPercent: 69, grievancesReported: 0, newHires: 2 },
    healthSafety: { recordableIncidents: 0, lostTimeIncidents: 0, fatalities: 0, hoursWorked: 46800 },
    training: { trainingHours: 390 },
    supplyChain: { suppliersAssessedPercent: 42 },
  },
  {
    period: '2025-06',
    energy: { electricityKwh: 205000, naturalGasKwh: 38000, vehicleFuelLiters: 3200, renewablePercent: 52, energySavingsKwh: 4200 },
    water: { consumptionM3: 740, waterSourceMunicipalPercent: 95 },
    waste: { totalKg: 14800, recycledKg: 11840, hazardousKg: 790, recyclingRate: 80 },
    workforce: { totalEmployees: 283, femaleEmployees: 76, maleEmployees: 207, turnoverRate: 10, womenInLeadershipPercent: 29, collectiveBargainingPercent: 69, grievancesReported: 0, newHires: 2 },
  ...
  {
    period: '2025-07',
    energy: { electricityKwh: 210000, naturalGasKwh: 32000, vehicleFuelLiters: 2400, renewablePercent: 54, energySavingsKwh: 2900 },
    water: { consumptionM3: 720, waterSourceMunicipalPercent: 95 },
    waste: { totalKg: 12800, recycledKg: 10370, hazardousKg: 650, recyclingRate: 81 },
    workforce: { totalEmployees: 278, femaleEmployees: 75, maleEmployees: 203, turnoverRate: 10, womenInLeadershipPercent: 30, collectiveBargainingPercent: 69, grievancesReported: 1, newHires: 1 },
  ...
  {
    period: '2025-08',
    energy: { electricityKwh: 195000, naturalGasKwh: 30000, vehicleFuelLiters: 2200, renewablePercent: 54, energySavingsKwh: 2500 },
    water: { consumptionM3: 680, waterSourceMunicipalPercent: 95 },
    waste: { totalKg: 11500, recycledKg: 9430, hazardousKg: 590, recyclingRate: 82 },
    workforce: { totalEmployees: 275, femaleEmployees: 74, maleEmployees: 201, turnoverRate: 11, womenInLeadershipPercent: 30, collectiveBargainingPercent: 69, grievancesReported: 0, newHires: 1 },
  ...
  {
    period: '2025-09',
    energy: { electricityKwh: 202000, naturalGasKwh: 48000, vehicleFuelLiters: 3100, renewablePercent: 55, energySavingsKwh: 3600 },
    water: { consumptionM3: 730, waterSourceMunicipalPercent: 95 },
    waste: { totalKg: 14100, recycledKg: 11560, hazardousKg: 740, recyclingRate: 82 },
    workforce: { totalEmployees: 280, femaleEmployees: 75, maleEmployees: 205, turnoverRate: 11, womenInLeadershipPercent: 30, collectiveBargainingPercent: 70, grievancesReported: 0, newHires: 3 },
    healthSafety: { recordableIncidents: 1, lostTimeIncidents: 0, fatalities: 0, hoursWorked: 46600 },
    training: { trainingHours: 450 },
    supplyChain: { suppliersAssessedPercent: 45 },
  },
  {
    period: '2025-10',
    energy: { electricityKwh: 196000, naturalGasKwh: 78000, vehicleFuelLiters: 3050, renewablePercent: 55, energySavingsKwh: 3400 },
    water: { consumptionM3: 700, waterSourceMunicipalPercent: 95 },
    waste: { totalKg: 13900, recycledKg: 11400, hazardousKg: 720, recyclingRate: 82 },
    workforce: { totalEmployees: 281, femaleEmployees: 76, maleEmployees: 205, turnoverRate: 11, womenInLeadershipPercent: 30, collectiveBargainingPercent: 70, grievancesReported: 1, newHires: 2 },
  ...
  {
    period: '2025-11',
    energy: { electricityKwh: 188000, naturalGasKwh: 112000, vehicleFuelLiters: 2900, renewablePercent: 55, energySavingsKwh: 3000 },
    water: { consumptionM3: 660, waterSourceMunicipalPercent: 95 },
    waste: { totalKg: 13200, recycledKg: 10820, hazardousKg: 700, recyclingRate: 82 },
    workforce: { totalEmployees: 282, femaleEmployees: 76, maleEmployees: 206, turnoverRate: 11, womenInLeadershipPercent: 31, collectiveBargainingPercent: 70, grievancesReported: 0, newHires: 2 },
    healthSafety: { recordableIncidents: 0, lostTimeIncidents: 0, fatalities: 0, hoursWorked: 46000 },
    training: { trainingHours: 430 },
    supplyChain: { suppliersAssessedPercent: 48 },
  },
  {
    period: '2025-12',
    energy: { electricityKwh: 182000, naturalGasKwh: 135000, vehicleFuelLiters: 2600, renewablePercent: 56, energySavingsKwh: 2700 },
    water: { consumptionM3: 610, waterSourceMunicipalPercent: 95 },
    waste: { totalKg: 12200, recycledKg: 10010, hazardousKg: 660, recyclingRate: 82 },
    workforce: { totalEmployees: 283, femaleEmployees: 77, maleEmployees: 206, turnoverRate: 11, womenInLeadershipPercent: 31, collectiveBargainingPercent: 70, grievancesReported: 0, newHires: 2 },
