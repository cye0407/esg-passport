...
export const ESG_KEYWORD_RULES = [
    ...
    { keywords: ['what certifications does your company hold', 'what certifications do you hold', 'list all certifications', 'all current certifications', 'certifications held', 'certifications with validity'], domain: 'regulatory', topics: ['certifications'], weight: 17 },
    ...
    { keywords: ['anti-corruption and anti-bribery policy', 'anti-corruption policy', 'anti-bribery policy'], domain: 'goals', topics: ['anti_corruption', 'ethics'], weight: 16 },
    { keywords: ['data protection and privacy policy', 'gdpr compliance', 'safeguarding personal and customer data'], domain: 'goals', topics: ['data_protection'], weight: 16 },
    ...
    { keywords: ['average number of training hours delivered per employee', 'training hours delivered per employee per year', 'hours of training per employee do you provide'], domain: 'training', topics: ['training_average'], weight: 16 },
    { keywords: ['training hours per employee', 'hours of training per employee', 'average number of training hours per employee'], domain: 'training', topics: ['training'], weight: 15 },
    { keywords: ['total training hours', 'total hours of training'], domain: 'training', topics: ['training_total'], weight: 15 },
    { keywords: ['percentage of employees received training', 'percent of employees received training'], domain: 'training', topics: ['training_participation'], weight: 15 },
    { keywords: ['what types of training do you provide', 'types of training do you provide', 'training do you provide'], domain: 'training', topics: ['training_types'], weight: 16 },
    { keywords: ['certified occupational health and safety management system', 'iso 45001', 'occupational health and safety management system'], domain: 'regulatory', topics: ['health_safety_management'], weight: 16 },
    { keywords: ['supplier code of conduct', 'do you have a supplier code of conduct'], domain: 'buyer_requirements', topics: ['supplier_code', 'ethics'], weight: 16 },
    { keywords: ['water management policy', 'water stewardship'], domain: 'energy_water', topics: ['water_policy'], weight: 17 },
    { keywords: ['environmental management system', 'environmental policy', 'sustainability-related certifications', 'what sustainability-related certifications'], domain: 'regulatory', topics: ['environmental_policy', 'certifications'], weight: 17 },
    { keywords: ['business model', 'principal products/services', 'markets served'], domain: 'products', topics: ['products_services', 'company_profile'], weight: 17 },
    { keywords: ['supplier non-compliance', 'esg non-compliance by a supplier', 'corrective action and escalation process'], domain: 'buyer_requirements', topics: ['supplier_non_compliance'], weight: 16 },
    { keywords: ['monitor ongoing esg performance of your supply chain', 'supplier risk screening', 'supply chain monitoring tools'], domain: 'buyer_requirements', topics: ['supply_chain_monitoring'], weight: 16 },
    { keywords: ['human rights due diligence', 'human rights risks in your own operations and supply chain', 'identify and mitigate human rights risks'], domain: 'workforce', topics: ['human_rights_due_diligence', 'human_rights'], weight: 16 },
    { keywords: ['formal human rights policy', 'forced labor, child labor, and freedom of association', 'human rights policy covering forced labor', 'child labor and freedom of association'], domain: 'workforce', topics: ['human_rights'], weight: 17 },
    { keywords: ['responsible sourcing policy for raw materials', 'conduct conflict minerals due diligence', 'cmrt/emrt', 'conflict minerals due diligence', 'responsible sourcing policy'], domain: 'materials', topics: ['conflict_minerals'], weight: 17 },
    { keywords: ['scope 3 transport-related emissions', 'fleet composition', 'business travel volume', 'employee commuting data'], domain: 'transport', topics: ['scope_3', 'business_travel'], weight: 16 },
    { keywords: ['reduce transport emissions', 'fleet electrification', 'route optimization', 'modal shift', 'remote work policies'], domain: 'transport', topics: ['transport_reduction', 'transport'], weight: 16 },
    ...
    { keywords: ['carbon neutral', 'net zero', 'net-zero', 'climate target', 'sbti', 'science based target', 'emission reduction target'], domain: 'goals', topics: ['climate_targets'], weight: 12 },
